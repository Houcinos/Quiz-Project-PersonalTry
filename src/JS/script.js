...
// push the question into availbaleQuestions Array
...
// make all the options unclickable once the user select an option (restrict the user to change the option again)
